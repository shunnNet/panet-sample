...
const app = new Vue({
    ...
    methods: {
        removeDemand(event, index, vee_validator) {
            this.form.demand.splice(index, 1)
            vee_validator.validate();
        },
        ...
        closeDemandForm() {
            ...
            this.demand_validator.validate();
            this.demand_validator = undefined;
        },
        activeDemandForm(event, index, vee_validator) {
            this.demand_validator = vee_validator
